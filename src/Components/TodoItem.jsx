  ...
  return (
    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={id}>
      ...
      <td className="px-6 py-4 flex gap-1">
        <button className="py-1 px-2 bg-red-500 text-white hover:bg-red-300">삭제</button>
        <button className="py-1 px-2 bg-green-500 text-white hover:bg-green-300">완료</button>
      </td>
    </tr>
  );
}
